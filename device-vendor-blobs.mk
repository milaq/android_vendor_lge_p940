...
# nxp
PRODUCT_COPY_FILES += \
    vendor/lge/p940/proprietary/LVVEFS_Rx_Configuration.txt:system/vendor/etc/LVVEFS_Rx_Configuration.txt \
    vendor/lge/p940/proprietary/LVVEFS_Tx_Configuration.txt:system/vendor/etc/LVVEFS_Tx_Configuration.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO_CARKIT.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO_CARKIT.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO_HEADSET.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_BLUETOOTH_SCO_HEADSET.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_EARPIECE.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_EARPIECE.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_SPEAKER.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_SPEAKER.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_WIRED_HEADPHONE.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_WIRED_HEADPHONE.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_NARROWBAND_WIRED_HEADSET.txt:system/vendor/etc/Rx_ControlParams_NARROWBAND_WIRED_HEADSET.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO_CARKIT.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO_CARKIT.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO_HEADSET.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_BLUETOOTH_SCO_HEADSET.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_EARPIECE.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_EARPIECE.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_SPEAKER.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_SPEAKER.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_WIRED_HEADPHONE.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_WIRED_HEADPHONE.txt \
    vendor/lge/p940/proprietary/Rx_ControlParams_WIDEBAND_WIRED_HEADSET.txt:system/vendor/etc/Rx_ControlParams_WIDEBAND_WIRED_HEADSET.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO_CARKIT.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO_CARKIT.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO_HEADSET.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_BLUETOOTH_SCO_HEADSET.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_EARPIECE.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_EARPIECE.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_SPEAKER.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_SPEAKER.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_WIRED_HEADPHONE.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_WIRED_HEADPHONE.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_NARROWBAND_WIRED_HEADSET.txt:system/vendor/etc/Tx_ControlParams_NARROWBAND_WIRED_HEADSET.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO_CARKIT.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO_CARKIT.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO_HEADSET.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_BLUETOOTH_SCO_HEADSET.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_EARPIECE.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_EARPIECE.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_SPEAKER.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_SPEAKER.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_WIRED_HEADPHONE.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_WIRED_HEADPHONE.txt \
    vendor/lge/p940/proprietary/Tx_ControlParams_WIDEBAND_WIRED_HEADSET.txt:system/vendor/etc/Tx_ControlParams_WIDEBAND_WIRED_HEADSET.txt
